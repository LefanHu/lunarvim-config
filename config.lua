...
--   name = "Spectre",
--   e = { "<cmd>lua require'spectre.actions'.select_entry()<CR>", "goto current file" },
-- }
lvim.builtin.which_key.mappings["R"] = { "<cmd>lua require'spectre'.open()<CR>", "Spectre" }
